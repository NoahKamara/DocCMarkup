...
public struct TaggedComponents: MarkupRewriter {
    ...
    public mutating func visitUnorderedList(_ unorderedList: UnorderedList) -> (any Markup)? {
    ...
    public mutating func visitListItem(_ listItem: ListItem) -> (any Markup)? {
        /*
    ...
    public mutating func visitDoxygenParameter(_ doxygenParam: DoxygenParameter) -> (any Markup)? {
        self.parameters.append(Parameter(doxygenParam))
        return nil
    }

    public mutating func visitDoxygenReturns(_ doxygenReturns: DoxygenReturns) -> (any Markup)? {
